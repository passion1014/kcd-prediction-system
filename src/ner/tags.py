...
LABEL_DESCRIPTIONS = {
    ...
    "ACT": {
        "name_ko": "행위/동작",
        "examples": ["운전", "보행", "탑승", "하차", "작업"],
        "description": "환자의 행위나 동작 (주로 사고 상황)"
    },
    "NEG": {
        "name_ko": "부정/배제",
        "examples": ["없음", "아님", "관찰안됨", "특이소견없음"],
        "description": "특정 소견이나 상황을 부정하는 표현"
    },
    "DIS_HIST": {
        "name_ko": "과거력/기왕증",
        "examples": ["당뇨병", "고혈압", "심장질환", "이전 수술 이력"],
        "description": "환자가 과거에 앓았거나 현재 기저 질환으로 가지고 있는 정보"
    },
}
